            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-10 lg:gap-16">
              ...
              <div className="md:col-span-3 space-y-3">
                ...
                <ul className="space-y-2 text-xs text-(--text-secondary)">
                  <li>
                    <Link to="/posts" className="hover:text-(--link) transition-colors">
                      <span className="hover:text-(--link) text-(--text-secondary)">My Posts</span>
                    </Link>
                  </li>
                  <li>
                    <Link to="/articles" className="hover:text-(--link) transition-colors">
