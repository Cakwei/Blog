...
import { ArrowLeft, ArrowRight, ArrowUpRight, Clock, Flame, Sparkles } from "lucide-react";
...
function HomeContent() {
    ...
    const activeFeaturedPosts = featuredPosts.length > 0 ? featuredPosts : postList.slice(0, 1);
    const remainingPosts = postList.filter((post) => !activeFeaturedPosts.includes(post));
