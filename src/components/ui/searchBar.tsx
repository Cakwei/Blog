...
import { ArrowUpRight, Compass, FileText, Loader2, Search, Terminal } from "lucide-react";
                                ...
                                <>
                                    ...
                                    {!isLoading && inputValue && searchResults.length === 0 && (
                                        <CommandEmpty className="py-10 text-center text-xs text-(--text-secondary)">
                                            No matches found for <span className="text-(--text) font-semibold">"{inputValue}"</span>
                                        </CommandEmpty>
                                    )}
                                    ...
                                    >
                                        ...
                                        >
                                            <div className="flex items-center gap-2.5">
                                                ...
                                                <span className="text-xs font-medium">Browse All Articles</span>
                                            </div>
                                            <span className="text-[10px] font-mono text-(--text-secondary)">/articles</span>
                                        </CommandItem>
                                    </CommandGroup>
                                </>
                            )}
